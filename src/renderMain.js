...
export default function renderMain(event) {
  ...
  for (let i = 0; i < myProjects[currentProjectIndex].tasks?.length; i++) {
    ...
    taskDescription.textContent =
      myProjects[currentProjectIndex].tasks[i].description;
    ...
    editBtn.addEventListener("click", (e) => {
      ...
      newTaskInput.value =
        myProjects[currentProjectIndex].tasks[currentTaskIndex].name;
      newPriorityInput.value =
        myProjects[currentProjectIndex].tasks[currentTaskIndex].priority;
      taskDescriptionInput.value =
        myProjects[currentProjectIndex].tasks[currentTaskIndex].description;
...
const submitNewTask = () => {
  ...
  if (!newTaskInput.value && !taskDescriptionInput.value) {
  ...
  } else if (!myProjects[currentProjectIndex].tasks) {
    ...
    reset();
    updateTaskContainer();
  } else if (myProjects[currentProjectIndex].tasks[currentTaskIndex]) {
    ...
    myProjects[currentProjectIndex].tasks.push(
      createTask(
        newTaskInput.value,
        newPriorityInput.value,
        taskDescriptionInput.value
